...
export const TodoBulmaTheme: TodoThemeSchema = {
  ...
  list: 'list p-2',
  list_item: 'list-item box is-flex is-align-items-center is-flex-wrap-wrap',
  list_itemDone: '',
  list_item_check: 'mr-3',
  list_item_text: 'is-flex-grow-1 mr-3',
  list_item_textDone: 'todo-line-through',
  list_item_textEditInput: 'textarea mb-2 mt-2',
  list_item_deleteButton: 'button is-danger',
  list_item_editButton: 'button is-warning ml-2',
  footer: 'is-flex-wrap-wrap p-2 mt-auto',
  footer_input: 'textarea mr-2 mb-2',
  footer_addButton: 'is-flex button is-primary',
  hidden: 'is-hidden'
};
